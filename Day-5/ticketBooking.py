...
#inside that create a function "book ticket" which will be the abstract method and has
 nothing in it.
#create a class "makemytrip" which will use the 'bookticket function' from "ticket" class
 to take the details such as 
#name, ph no, email id,journey date and displays a message saying Thsnk u from booking
 from makemytrip.
#create a class "irctc" which uses the 'bookticket' of "ticket" class and takes the same
 details as makemytrip but 
#in the end it will give an option to user to select whether it is one way or round trip
#if the user option is round trip it again asks the user to enter the return date as 
well and then prints a message 
#thank u for choosing irctc else it prints a message thank u for choosing irctc.
#create a class indigo which takes all the details as irctc and just asks which mode 
of transport u want to go in 
...
class makemytrip(ticket):
    ...
    def bookTicket():
        ...
        print("Thank You,",name," for choosing MakeMyTrip")
...
class irctc(ticket):
      def bookTicket():
        ...
        print("Thank You,",name," for choosing IRCTC")
...
class indigo(ticket):
      def bookTicket():
        ...
        print("Thank You,",name," for choosing INDIGO ")
